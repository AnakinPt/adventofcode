...
public class Main {
   ...
   public static void calculateFirst(){
       ...
       System.out.println("Result: "+ new CalculateCalibration().calculate(text));
   }

    public static void calculateSecond(){
        String text = getString();
        System.out.println("Result: "+ new CalculateCalibration().calculateWithLettersToo(text));
   }


    private static String getString() {
        String text = "2911threeninesdvxvheightwobm\n" +
